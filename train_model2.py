...
if __name__ == "__main__":
    ...
    user_tfidf_cols = []
    for i in range(10):
        jd_tfidf_cols.append(f'jd_tfidf_{i}')
        user_tfidf_cols.append(f'user_tfidf_{i}')
    ...
    use_feats = ['same_user_city', 'gt_edu', 'min_desire_salary_num', 'max_desire_salary_num', 'same_jd_sub',
    ...
    if use_doc2vec:
        ...
        use_feats.extend(user_D2V_cols)
        use_feats.extend(jd_D2V_cols)
    ...
    # jd feats
    train_jd = gen_jd_feats(train_jd, model_doc2vec, use_tfidf=False, use_doc2vec=use_doc2vec)
    # user feats
    train_user = gen_user_feats(train_user, model_doc2vec, use_tfidf=False, use_doc2vec=use_doc2vec)
